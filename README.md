...
- **[genomics-pipeline](https://github.com/GeiserX/genomics-pipeline)** - A 27-step whole-genome sequencing analysis pipeline for consumer hardware, fully Dockerized with no cloud dependencies. [ [docs](https://geiserx.github.io/genomics-pipeline) ]
